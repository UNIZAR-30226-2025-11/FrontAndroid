      ...
      body: Container(
        ...
        child: isLoading
          ...
          children: [
            ...
            SafeArea(
              child: Padding(
                padding: const EdgeInsets.fromLTRB(16.0, 100.0, 16.0, 100.0), // Add more top padding only if needed
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                ...
                                title: Text(
                                  '${game.isWinner ? 'Victory' : 'Defeat'} - ${_formatTimeAgo(game.gameDate)}',
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.bold,
                                  ),
...
// Función para mostrar hace cuánto tiempo fue una partida
