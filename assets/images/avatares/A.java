                      ...
                      GridView.builder(
                        ...
                        itemBuilder: (context, productIndex) {
                          ...
                          if (category.name.toLowerCase().contains('avatar')) {
                            imagePath = 'images/avatares/${product.name.toLowerCase()}.png';
                          } else {
                            imagePath = 'images/backgrounds/${product.name.toLowerCase()}.png';
                          }
...
// This is just a placeholder for the session manager class
// You should replace this with your actual implementation
class SessionManager {
  static Future<String?> getUsername() async {
    // Implement your session storage logic
    return 'username';
  }
...
// Placeholder classes for the navigation routes
class StatisticsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(child: Text('Statistics for $username')),
    );
  }
}
...
class EditProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(child: Text('Edit profile for $username')),
    );
  }
}
